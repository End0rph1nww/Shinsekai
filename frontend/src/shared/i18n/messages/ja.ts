...
export const jaMessages: Record<MessageKey, string> = {
  ...
  "plugin.publisher.entry": "エントリクラス",
  "plugin.publisher.entryAuto": "自動検出エントリ",
  "plugin.publisher.githubIssue": "GitHub Issue に送信",
  "plugin.publisher.localPath": "任意：プラグインソースフォルダ",
  "plugin.publisher.logo": "Logo パス",
  ...
  "plugin.publisher.scanDone": "ソースフォルダからメタデータを読み込みました",
  "plugin.publisher.shinsekaiVersion": "対応 Shinsekai バージョン",
  "plugin.publisher.socialLink": "作者リンク",
  "plugin.publisher.subtitle":
    "プラグインメタデータを入力し、マーケットと同じ Registry Issue Payload を生成します。ソースフォルダはフォーム補完だけに使い、アップロードされません。最終的な梱包は GitHub CI がリポジトリ URL から取得して行います。",
  ...
  "plugin.publisher.version": "プラグインバージョン",
  "plugin.publisher.warnings": "スキャンメモ",
  "plugin.directory": "場所",
