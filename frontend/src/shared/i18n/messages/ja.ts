...
export const jaMessages: Record<MessageKey, string> = {
  ...
  "plugin.publisher.localPath": "ローカルプラグインフォルダ",
  ...
  "plugin.publisher.scan": "フォルダをスキャン",
  "plugin.publisher.scanDone": "ローカルプラグイン情報を読み込みました",
  "plugin.publisher.socialLink": "作者リンク",
  "plugin.publisher.subtitle": "プラグインメタデータを入力し、マーケットと同じ Registry Issue Payload を生成します。",
