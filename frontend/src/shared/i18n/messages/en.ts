...
export const enMessages: Record<MessageKey, string> = {
  ...
  "plugin.publisher.entry": "Entry class",
  "plugin.publisher.entryAuto": "Auto-detected entry",
  "plugin.publisher.githubIssue": "Submit to GitHub Issue",
  "plugin.publisher.localPath": "Optional: plugin source folder",
  "plugin.publisher.logo": "Logo path",
  ...
  "plugin.publisher.scanDone": "Metadata loaded from source folder",
  ...
  "plugin.publisher.subtitle":
    "Fill plugin metadata and generate the same Registry Issue payload used by the market. The source folder only prefills the form and is never uploaded; GitHub CI still pulls code from the repository URL.",
  ...
  "plugin.publisher.version": "Plugin version",
  "plugin.publisher.warnings": "Scan notes",
