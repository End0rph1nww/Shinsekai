...
export const enMessages: Record<MessageKey, string> = {
  ...
  "plugin.publisher.localPath": "Local plugin folder",
  ...
  "plugin.publisher.scan": "Scan folder",
  "plugin.publisher.scanDone": "Local plugin metadata loaded",
  "plugin.publisher.socialLink": "Author link",
  "plugin.publisher.subtitle": "Fill plugin metadata and generate the same Registry Issue payload used by the market.",
