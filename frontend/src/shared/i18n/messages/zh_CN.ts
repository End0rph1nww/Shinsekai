...
export const zhCNMessages: Record<MessageKey, string> = {
  ...
  "plugin.publisher.githubIssue": "打开 GitHub Issue",
  "plugin.publisher.localPath": "本地插件目录",
  ...
  "plugin.publisher.scan": "扫描目录",
  "plugin.publisher.scanDone": "已读取本地插件信息",
  "plugin.publisher.socialLink": "作者链接",
  "plugin.publisher.subtitle": "填写插件元数据，生成与插件市场一致的 Registry Issue Payload。",
