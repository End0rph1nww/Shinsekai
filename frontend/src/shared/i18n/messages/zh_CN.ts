...
export const zhCNMessages: Record<MessageKey, string> = {
  ...
  "plugin.publisher.entry": "入口类",
  "plugin.publisher.entryAuto": "自动识别入口",
  "plugin.publisher.githubIssue": "提交到 GitHub Issue",
  "plugin.publisher.localPath": "可选：插件源码目录",
  "plugin.publisher.logo": "Logo 路径",
  ...
  "plugin.publisher.scanDone": "已从源码目录读取元数据",
  "plugin.publisher.shinsekaiVersion": "支持 Shinsekai 版本",
  "plugin.publisher.socialLink": "社交链接（可选）",
  "plugin.publisher.subtitle":
    "填写插件元数据，生成与插件市场一致的 Registry Issue Payload。源码目录只用于自动填表，不会被上传；最终仍由 GitHub CI 从仓库拉取源码打包。",
  "plugin.publisher.tags": "标签",
  "plugin.publisher.title": "提交插件到市场",
  "plugin.publisher.validate": "校验",
  "plugin.publisher.validated": "插件提交信息已通过校验",
  "plugin.publisher.version": "插件版本",
  "plugin.publisher.warnings": "扫描提示",
  "plugin.directory": "位置",
